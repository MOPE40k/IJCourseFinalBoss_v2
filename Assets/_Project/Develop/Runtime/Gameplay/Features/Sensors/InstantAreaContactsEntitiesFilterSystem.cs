...
{
    public class InstantAreaContactsEntitiesFilterSystem : IInitializableSystem
    {
        ...
        public InstantAreaContactsEntitiesFilterSystem(CollidersRegistryService collidersRegistryService)
