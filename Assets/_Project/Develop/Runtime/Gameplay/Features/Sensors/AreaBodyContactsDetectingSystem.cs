...
{
    public class AreaBodyContactsDetectingSystem : IInitializableSystem, IUpdatableSystem
    {
        private ReactiveVariable<float> _radiusAreaAttack = null;
        ...
        {
            _radiusAreaAttack = entity.RadiusAreaAttack;
